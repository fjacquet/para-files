...
- [ ] 11-01-PLAN.md — Performance improvements: adaptive threading, hash cache, centralized content truncation (PERF-01, PERF-02, PERF-03)
- [ ] 11-02-PLAN.md — Pipeline order tests and concurrent move tests (TEST-01, TEST-03)
