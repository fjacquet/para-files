...
### Workflow 4: Set Up New PARA Folders

```bash
# Create folder structure from reference tree
uv run para-files init --subfolders --dry-run
...
### Video/Course Detection

Learning content is routed to Resources:

```
3_Resources/formations/udemy/python-course/
```
...
# Or create a .env file
echo 'PARA_FILES_PARA_ROOT="/your/path"' > .env
```
